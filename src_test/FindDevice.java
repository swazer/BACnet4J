...
public class FindDevice {
    ...
    static void test2() throws Exception {
        ...
        try {
            ...
            RemoteDevice d = localDevice.findRemoteDevice(new Address(0, "127.0.0.1:47808"), null, 31415);
    ...
    static void test1() throws Exception {
        ...
        try {
            ...
            RemoteDevice d = localDevice.findRemoteDevice(new Address(36, (byte) 1), new OctetString(
                    "89.101.141.54:47808"), 1001);
            System.out.println(d);
