...
public class DeserializationTest {
    ...
    static void test5() throws Exception {
        WhoHasRequest req = new WhoHasRequest(new WhoHasRequest.Limits(new UnsignedInteger(0), new UnsignedInteger(
                4194303)), new CharacterString("ELEC"));
        ByteQueue queue = new ByteQueue();
        req.write(queue);
        System.out.println(queue);
        new WhoHasRequest(queue);
    ...
    static void test6() throws Exception {
        WhoHasRequest req = new WhoHasRequest(new WhoHasRequest.Limits(new UnsignedInteger(0), new UnsignedInteger(
                4194303)), new ObjectIdentifier(ObjectType.accessDoor, 5));
        ByteQueue queue = new ByteQueue();
        req.write(queue);
        System.out.println(queue);
        new WhoHasRequest(queue);
