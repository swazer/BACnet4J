...
public class UnsignedOutOfRange extends NotificationParameters {
    private static final long serialVersionUID = 5672684845327859604L;
    ...
    public UnsignedOutOfRange(UnsignedInteger exceedingValue, StatusFlags statusFlags, UnsignedInteger deadband,
            UnsignedInteger exceedingLimit) {
