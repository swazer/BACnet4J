...
public class Ipv6Network /* extends Network implements Runnable */{
    ...
    //    public Ipv6Network(String multicastAddress, int localNetworkNumber) {
    ...
    //        return new Ipv6NetworkIdentifier(multicastAddress);
    //    }
    ...
    //    private static final int REGISTER_FOREIGN_DEVICE_LENGTH = 9;
    //
    //    /**
